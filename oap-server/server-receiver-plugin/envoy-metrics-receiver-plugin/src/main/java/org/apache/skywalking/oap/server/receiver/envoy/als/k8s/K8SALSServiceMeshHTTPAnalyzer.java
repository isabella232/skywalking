...
public class K8SALSServiceMeshHTTPAnalyzer extends AbstractALSAnalyzer {
    ...
    protected List<ServiceMeshMetric.Builder> analyzeSideCar(final HTTPAccessLogEntry entry) {
        ...
        if (cluster.startsWith("inbound|")) {
            // Server side
            final ServiceMeshMetric.Builder metrics = adaptToDownstreamMetrics(entry)
            ...
            if (downstreamService.equals(ServiceMetaInfo.UNKNOWN)) {
                ...
                metrics.setSourceServiceName(downstreamService.getServiceName())
            ...
            final ServiceMeshMetric.Builder metric = adaptToDownstreamMetrics(entry)
